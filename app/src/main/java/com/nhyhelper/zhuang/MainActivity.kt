...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupSettingsButtons() {
        ...
        binding.tabSettings.projectLink.setOnClickListener {
            try {
                startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/QiCaiJie114514/QQMiaoAssistant")))
            } catch (e: Exception) {
                toast("无法打开链接")
            }
        }
    ...
    private fun setupVersionBadge() {
        try {
            ...
            binding.tabMain.versionBadge.text = "v1.1"
            binding.tabSettings.aboutAppVersion.text = "v 1.1"
        }
    }
